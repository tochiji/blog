...
type PostsQuery = { readonly posts: { readonly edges: ReadonlyArray<{ readonly node: { readonly fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date'>> } }> } };
...
type TopQueryVariables = Exact<{ [key: string]: never; }>;


type TopQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'image' | 'siteUrl'>> }> };
