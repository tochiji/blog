...
type SiteSiteMetadataFilterInput = {
  ...
  readonly image: Maybe<StringQueryOperatorInput>;
  readonly twitterImage: Maybe<StringQueryOperatorInput>;
...
type SiteSiteMetadataSocialTwitterFilterInput = {
  readonly account: Maybe<StringQueryOperatorInput>;
...
type SiteFieldsEnum =
  ...
  | 'siteMetadata.social.twitter.account'
...
type PostQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'siteUrl'>> }>, readonly markdownRemark: Maybe<(
    ...
    & { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'description' | 'date' | 'image'>>, readonly fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>> }
  )> };
...
type FooterQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<{ readonly social: Maybe<{ readonly twitter: Maybe<Pick<SiteSiteMetadataSocialTwitter, 'url'>>, readonly github: Maybe<Pick<SiteSiteMetadataSocialGithub, 'url'>> }> }> }> };

type HeadQueryVariables = Exact<{ [key: string]: never; }>;


type HeadQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description' | 'image' | 'twitterImage' | 'siteUrl'>
      & { readonly social: Maybe<{ readonly twitter: Maybe<Pick<SiteSiteMetadataSocialTwitter, 'account'>> }> }
    )> }> };
